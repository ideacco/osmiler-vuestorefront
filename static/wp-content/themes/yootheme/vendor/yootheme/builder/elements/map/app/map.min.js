...
;(function (U, l) {
  ...
  function F(t, e) {
    var o = e.type,
      ...
      a,
      m = new google.maps.InfoWindow({ maxWidth: M ? parseInt(M, 10) : 300 })
  ...
  function k(t) {
    return l.$('link[href="' + t + '"]')
      ? l.Promise.resolve()
      : new l.Promise(function (e) {
          return l.once(
            l.append(document.head, '<link href="' + t + '" rel="stylesheet">'),
            'load',
            e
          )
        })
  ...
  function q(t, e) {
    ...
    var z
    if (w) {
      var M = { showCoverageOnHover: !1 }
      s &&
        (M.iconCreateFunction = function (p) {
          ...
          return new L.DivIcon({
            html:
              '<img src="' +
              a.url +
              '" alt><span class="uk-position-center"' +
              m +
              '>' +
              u +
              '</span>',
    ...
    I &&
      I.forEach(function (p) {
        var u = p.lat,
          ...
          P = p.iconSize,
          i = p.iconAnchor,
          g = L.marker({ lat: u, lng: a })
        if (
          (_ && g.setIcon(L.icon({ iconUrl: _, iconSize: P, iconAnchor: i })),
          z ? z.addLayer(g) : g.addTo(f),
          m)
        ) {
          var y = { maxWidth: A ? parseInt(A, 10) : 300 }
  ...
  B.default.component('Map', {
    connected: function () {
      var e,
        o = this
      if (
        ((this.script = this.script || l.$('script', this.$el)), !!this.script)
      ) {
        this.map = JSON.parse(this.script.textContent)
        var n = l.$$('template', this.$el)
        ;(e = this.map.markers) == null ||
          e.forEach(function (r, d) {
            ;(r.content = n[d].innerHTML.trim()),
              !r.icon &&
                o.map.icon &&
                ((r.icon = o.map.icon),
                (r.iconSize = o.map.iconSize),
                (r.iconAnchor = o.map.iconAnchor))
          }),
          requestAnimationFrame(function () {
            o.map.lazyload && 'IntersectionObserver' in window
    ...
    methods: {
      load: function () {
        var e, o, n
        ;((e = this.map) == null ? void 0 : e.library) === 'google' &&
          (o = window.google) != null &&
          o.maps &&
          F(this.$el, this.map),
          ((n = this.map) == null ? void 0 : n.library) === 'leaflet' &&
            window.L &&
            j(this.$el, this.map)
      },
    },
