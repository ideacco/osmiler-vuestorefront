    ...
    <div class="uk-container">
      ...
      >
        <div class="uk-first-column">
          <h1 class="uk-text-center">Terms and Conditions</h1>
          <hr />
          <div class="uk-panel uk-margin">
            <h3>OVERVIEW</h3>
            <p>
              This website/application is operated by osmiler.com team.
              Throughout the website/application, the terms “we”, “us” and “our”
              refer to osmiler.com team. osmiler.com offers this
              website/application, including all information, tools and services
            ...
            <p>
              ...
              those additional terms, conditions and policies referenced herein
            ...
            <p>
              ...
              or using our website/application. By accessing or using any part
              of the site, you agree to be bound by these TERMS AND CONDITIONS.
              If you do not agree to all the terms and conditions of this
              agreement, then you may not access the website/application or use
              any services. If these TERMS AND CONDITIONS are considered an
              offer, acceptance is expressly limited to these TERMS AND
              CONDITIONS.
            </p>
            <p>
              Any new features or tools which are added to the current store
              shall also be subject to the TERMS AND CONDITIONS. You can review
              the most current version of the TERMS AND CONDITIONS at any time
              on this page. We reserve the right to update, change or replace
              any part of these TERMS AND CONDITIONS by posting updates and/or
              changes to our website/application. It is your responsibility to
              check this page periodically for changes. Your continued use of or
              access to the website/application following the posting of any
              changes constitutes acceptance of those changes.
            </p>
            <h3>SECTION 1 – ONLINE STORE TERMS</h3>
            <p>
              By agreeing to these TERMS AND CONDITIONS, you may not use our
            ...
            <p>
              ...
              to the Service or any contact on the website/application through
            ...
            <h3>
              <a
                id="section-5-products-or-services-if-applicable"
                class="anchor"
                aria-hidden="true"
            ...
            <p>
              ...
              through the website/application. These products or services may
            ...
            <h3>
              <a
                id="section-6-accuracy-of-billing-and-account-information"
                class="anchor"
                aria-hidden="true"
              ><span class="octicon octicon-link"></span></a
            ...
            <h3>
              <a
                id="section-9-user-comments-feedback-and-other-submissions"
                class="anchor"
                aria-hidden="true"
              ><span class="octicon octicon-link"></span></a
            ...
            <p>
              ...
              Service or any related website/application. You may not use a
            ...
            <h3>
              <a
                id="section-10-personal-information"
                class="anchor"
                aria-hidden="true"
              ><span class="octicon octicon-link"></span></a
            ...
            <h3>
              <a
                id="section-11-errors-inaccuracies-and-omissions"
                class="anchor"
                aria-hidden="true"
              ><span class="octicon octicon-link"></span></a
            ...
            <p>
              ...
              website/application is inaccurate at any time without prior notice
              (including after you have submitted your order).
            </p>
            <p>
              We undertake no obligation to update, amend or clarify information
              in the Service or on any related website/application, including
            ...
            <p>
              ...
              the Service or of any related website/application, other websites,
              ...
              or any related website/application, other websites, or the
              Internet. We reserve the right to terminate your use of the
              Service or any related website/application for violating any of
              the prohibited uses.
            </p>
            <h3>
              <a
                id="section-13-disclaimer-of-warranties-limitation-of-liability"
                class="anchor"
                aria-hidden="true"
              ><span class="octicon octicon-link"></span></a
            ...
            <h3>
              <a
                id="section-17-entire-agreement"
                class="anchor"
                aria-hidden="true"
              ><span class="octicon octicon-link"></span></a
            ...
            <p>
              Any ambiguities in the interpretation of these TERMS AND
              CONDITIONS shall not be construed against the drafting party.
            </p>
            <h3>
              <a
                id="section-18-governing-law"
                class="anchor"
                aria-hidden="true"
              ><span class="octicon octicon-link"></span></a
            ...
            <h3>
              <a
                id="section-19-changes-to-terms-and-conditions"
                class="anchor"
                aria-hidden="true"
              ><span class="octicon octicon-link"></span></a
            ...
            <p>
              ...
              CONDITIONS at any time at this page.
            </p>
            <p>
              We reserve the right, at our sole discretion, to update, change or
              replace any part of these TERMS AND CONDITIONS by posting updates
              and changes to our website/application. It is your responsibility
              to check our website/application periodically for changes. Your
              continued use of or access to our website/application or the
              Service following the posting of any changes to these TERMS AND
